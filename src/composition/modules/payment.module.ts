...
import { PrismaPaymentWorkflowAdapter } from '@/infrastructure/persistence/workflows/prisma-payment-workflow.adapter';
...
@Module({
  ...
  providers: [
    ...
    { provide: PAYMENT_REPOSITORY_PORT, useExisting: PrismaPaymentRepository },
    {
      ...
      useExisting: PrismaPaymentWorkflowAdapter,
    },
    {
